...
export const Hero: React.FC = () => {
  return (
    <>
      <div className="hero h-screen w-full bg-midnight_text relative overflow-hidden pt-33 pb-20 ">
        ...
        <div className="shape-2 absolute z-30 bottom-0 rigth-0 w-[300px] h-auto flex justify-center items-start">
        ...
        <div className="solution-box absolute lg:block hidden lg:bottom-5 bottom-0 lg:right-5 right-0 bg-white/10 backdrop-blur-sm p-8 max-w-md rounded-md z-10">
          ...
          <p className="text-white pt-3 pb-8">
            Commited to deliverying innovative solutions that drive success.
